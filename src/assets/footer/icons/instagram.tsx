export const Instagram = () => {
  return (
    ...
    >
      <rect width="42" height="42" rx="21" fill="white" fillOpacity="0.18" />
      <rect x="10" y="10" width="22" height="22" fill="url(#pattern0_353_9)" />
      <defs>
        <pattern
          id="pattern0_353_9"
          ...
          height="1"
        >
          <use xlinkHref="#image0_353_9" transform="scale(0.0111111)" />
        </pattern>
        <image
          id="image0_353_9"
          width="90"

...
const WhatWeBuild = () => {
  return (
    <Section styles={{ marginBottom: "20rem" }}>
      ...
      <h2 className="xl:w-[200%] text-center text-large md:text-title-8 lg:text-title-6 xl:text-title-5 leading-tight mb-10">
        ¿Tienes una idea? <br />
        NOSOTROS LO DESARROLLAMOS <br />
        POR TÍ
      </h2>
      <WindowCard active>
        <div className="relative w-full grid grid-cols-12 gap-4 pt-8 xl:pt-28 px-3 xl:px-5 pb-4 xl:pb-10 ">
